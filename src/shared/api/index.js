...
export const app = {
  ...
  createDreamAddress: (data) => requests.post(ENDPOINTS.DREAM_ADDRESS, data),
  getDreamAddresses: () => requests.get(ENDPOINTS.DREAM_ADDRESS),
  deleteDreamAddress: (id) => requests.delete(`${ENDPOINTS.DREAM_ADDRESS}/${id}`),
  ...
  getBookmarks: () => requests.get(`${ENDPOINTS.GET_BOOKMARKS}`),
  createBookmark: (data) => requests.post(`${ENDPOINTS.GET_BOOKMARKS}`, data),
  deleteBookmark: (id) => requests.delete(`${ENDPOINTS.GET_BOOKMARKS}/${id}`),
  ...
  deleteSavedLocation: (id) => requests.delete(`${ENDPOINTS.SAVED_LOCATIONS}/${id}`),
